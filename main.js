...
console.log("directional key");
}

else if ((keyPressed >=37 && keyPressed<=40) || (keyPressed >=27))
{
	espacialkey();
document.getElementById("d1").innerHTML="Voce pressionou uma tecla espacial";
console.log("espacial key");
}
